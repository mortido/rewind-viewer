...
public struct RewindEvent : IFlatbufferObject
{
  private Table __p;
  ...
  public static RewindEvent GetRootAsRewindEvent(ByteBuffer _bb, RewindEvent obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
...
static public class RewindEventVerify
{
