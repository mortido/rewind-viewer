...
public struct Arc : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Arc GetRootAsArc(ByteBuffer _bb) { return GetRootAsArc(_bb, new Arc()); }
  public static Arc GetRootAsArc(ByteBuffer _bb, Arc obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  ...
  public static Offset<rewind_viewer.fbs.Arc> EndArc(FlatBufferBuilder builder) {
