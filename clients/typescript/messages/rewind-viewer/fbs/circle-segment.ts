...
static getRootAsCircleSegment(bb:flatbuffers.ByteBuffer, obj?:CircleSegment):CircleSegment {
  return (obj || new CircleSegment()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsCircleSegment(bb:flatbuffers.ByteBuffer, obj?:CircleSegment):CircleSegment {
...
static startCircleSegment(builder:flatbuffers.Builder) {
...
static endCircleSegment(builder:flatbuffers.Builder):flatbuffers.Offset {
