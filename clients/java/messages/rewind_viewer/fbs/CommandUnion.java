...
public class CommandUnion {
  ...
  public rewind_viewer.fbs.ArcT asArc() { return (rewind_viewer.fbs.ArcT) value; }
  ...
  public rewind_viewer.fbs.CircleSegmentT asCircleSegment() { return (rewind_viewer.fbs.CircleSegmentT) value; }
  ...
  public rewind_viewer.fbs.TilesT asTiles() { return (rewind_viewer.fbs.TilesT) value; }
  ...
  public static int pack(FlatBufferBuilder builder, CommandUnion _o) {
    switch (_o.type) {
      case Command.Arc: return rewind_viewer.fbs.Arc.pack(builder, _o.asArc());
      ...
      case Command.CircleSegment: return rewind_viewer.fbs.CircleSegment.pack(builder, _o.asCircleSegment());
      ...
      case Command.Tiles: return rewind_viewer.fbs.Tiles.pack(builder, _o.asTiles());
