...
public final class CircleSegment extends Table {
  ...
  public static CircleSegment getRootAsCircleSegment(ByteBuffer _bb, CircleSegment obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int endCircleSegment(FlatBufferBuilder builder) {
