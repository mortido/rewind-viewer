...
void FlatBuffersHandler::handle_message(const uint8_t* data, [[maybe_unused]] int32_t nbytes) {
    ...
    switch (msg->command_type()) {
        ...
        case fbs::Command_Triangle: {
            ...
            ctx.add_triangle(points[0], points[1], points[2],
        ...
        case fbs::Command_Popup: {
            ...
            get_frame_editor().add_box_popup(
                {popup->area_position()->x(), popup->area_position()->y()},
        ...
        case fbs::Command_PopupRound: {
            ...
            get_frame_editor().add_round_popup(
                {popup->area_center()->x(), popup->area_center()->y()}, popup->area_radius(),
                popup->text()->str());
            break;
        }
